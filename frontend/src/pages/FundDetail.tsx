/**
 * Fund detail page showing valuation and holdings.
 */
import React, { useState, useEffect, useCallback } from 'react';
import { useParams, useNavigate } from 'react-router-dom';
import {
  Layout, Typography, Card, Button, Spin, Alert, Row, Col, Tabs, Table, Space
} from 'antd';
import { ArrowLeftOutlined, ReloadOutlined, InfoCircleOutlined, StarFilled, StarOutlined } from '@ant-design/icons';
  ...
  return (
    <Layout style={{ minHeight: '100vh', background: '#f5f5f5' }}>
      <Content style={{ maxWidth: 1200, margin: '0 auto', padding: '48px 24px' }}>
        ...
        {/* Fund Header - Reference Image Layout */}
